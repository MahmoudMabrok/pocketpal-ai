...
export const l10n = {
   ar: {
    attachmentButtonAccessibilityLabel: 'إرسال وسائط',
emptyChatPlaceholder: 'لا توجد رسائل هنا بعد',
fileButtonAccessibilityLabel: 'ملف',
inputPlaceholder: 'رسالة',
sendButtonAccessibilityLabel: 'إرسال',
modelNotLoaded: 'لم يتم تحميل النموذج. يرجى تهيئة النموذج.',
loadingModel: 'جارٍ تحميل النموذج ...',
typeYourMessage: 'اكتب رسالتك هنا',
conversationReset: 'تم إعادة تعيين المحادثة!',
networkError: 'خطأ في الشبكة. حاول مرة أخرى.',
goToModels: 'الانتقال إلى النماذج',
readyToChat: 'جاهز للدردشة؟ قم بتحميل النموذج المستخدم الأخير.',
pleaseLoadModel: 'يرجى تحميل نموذج للبدء في الدردشة.',
shortMemoryWarning: 'تحذير الذاكرة',
memoryWarning: "تحذير: حجم النموذج قريب من أو يتجاوز الذاكرة الكلية لجهازك ({{totalMemory}} جيجابايت). قد يتسبب ذلك في بطء الأداء أو عدم استقرار النظام.",
load: 'تحميل',
cancel: 'إلغاء',
download: 'تنزيل',
offload: 'إلغاء التحميل',
reset: 'إعادة تعيين',
delete: 'حذف',
dismiss: 'تجاهل',
replace: 'استبدال',
...
fileAlreadyExistsMessage: 'يوجد ملف بهذا الاسم بالفعل. ماذا تود أن تفعل؟',
addLocalModel: 'إضافة نموذج محلي',
localModel: 'نموذج محلي',
resetModels: 'إعادة تعيين النماذج',
downloaded: 'تم التنزيل',
grouped: 'مجمّع',
proceedWithReset: 'المتابعة مع إعادة التعيين',
confirmReset: 'تأكيد إعادة التعيين',
modelSettingsTitle: 'إعدادات النموذج',
autoOffloadLoad: 'إلغاء التحميل/التحميل تلقائيًا',
autoOffloadLoadDescription: 'إلغاء تحميل النموذج عندما يكون التطبيق في الخلفية.',
metal: 'معدن',
metalDescription: 'واجهة برمجية معجلة للأجهزة من Apple.',
layersOnGPU: 'الطبقات على وحدة معالجة الرسوميات: {{gpuLayers}}',
contextSize: 'حجم السياق',
contextSizePlaceholder: 'أدخل حجم السياق (الحد الأدنى {{minContextSize}})',
invalidContextSizeError: 'يرجى إدخال رقم صالح (الحد الأدنى {{minContextSize}})',
modelReloadNotice: 'يلزم إعادة تحميل النموذج لتطبيق التغييرات.',
autoNavigateToChat: 'التنقل التلقائي إلى الدردشة',
autoNavigateToChatDescription: 'التنقل إلى الدردشة عند بدء التحميل.',
uiSettingsTitle: 'إعدادات واجهة المستخدم',
darkMode: 'الوضع الداكن',
darkModeDescription: 'تبديل الوضع الداكن تشغيل أو إيقاف.',
displayMemoryUsage: 'عرض استخدام الذاكرة',
displayMemoryUsageDescription: 'عرض استخدام الذاكرة في صفحة الدردشة.'
